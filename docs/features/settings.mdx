...
Select which AI model to use for the financial advisor chat. The default is `openai/gpt-4o-mini`. The model identifier follows the format `provider/model-name`.

...
**Before starting work on a ticket, move it to "In Progress" in Linear immediately.** This prevents other agents from picking the same ticket. If a ticket is already "In Progress", skip it and pick another one.
